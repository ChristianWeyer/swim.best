...
- (void)clearCookies:(CDVInvokedUrlCommand*)command {
    // CW: patch: If the user explicitly clicks "log out" in the UI, we need to
    // trash the InAppBrowser's cookies.
    // Following code is from http://stackoverflow.com/questions/4471629/how-to-delete-all-cookies-of-uiwebview
